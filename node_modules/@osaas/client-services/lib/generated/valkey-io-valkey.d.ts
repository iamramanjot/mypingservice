...
export type ValkeyIoValkey = paths['/valkeyinstance/{id}']['get']['responses']['200']['schema'];
export type ValkeyIoValkeyConfig = paths['/valkeyinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createValkeyIoValkeyInstance(ctx: Context, body: ValkeyIoValkeyConfig): Promise<ValkeyIoValkey>;
/**
 ...
 */
export declare function removeValkeyIoValkeyInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {ValkeyIoValkey} - Service instance
 */
export declare function getValkeyIoValkeyInstance(ctx: Context, name: string): Promise<ValkeyIoValkey>;
//# sourceMappingURL=valkey-io-valkey.d.ts.map