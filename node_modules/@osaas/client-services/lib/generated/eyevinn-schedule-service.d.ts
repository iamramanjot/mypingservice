...
export type EyevinnScheduleService = paths['/schedule-serviceinstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnScheduleServiceConfig = paths['/schedule-serviceinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnScheduleServiceInstance(ctx: Context, body: EyevinnScheduleServiceConfig): Promise<EyevinnScheduleService>;
/**
 ...
 */
export declare function removeEyevinnScheduleServiceInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnScheduleService} - Service instance
 */
export declare function getEyevinnScheduleServiceInstance(ctx: Context, name: string): Promise<EyevinnScheduleService>;
//# sourceMappingURL=eyevinn-schedule-service.d.ts.map