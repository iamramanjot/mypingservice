...
export type DocusealcoDocuseal = paths['/docusealinstance/{id}']['get']['responses']['200']['schema'];
export type DocusealcoDocusealConfig = paths['/docusealinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createDocusealcoDocusealInstance(ctx: Context, body: DocusealcoDocusealConfig): Promise<DocusealcoDocuseal>;
/**
 ...
 */
export declare function removeDocusealcoDocusealInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {DocusealcoDocuseal} - Service instance
 */
export declare function getDocusealcoDocusealInstance(ctx: Context, name: string): Promise<DocusealcoDocuseal>;
//# sourceMappingURL=docusealco-docuseal.d.ts.map