...
export type AnderswassenChaosproxyConfig = paths['/chaosproxy-configinstance/{id}']['get']['responses']['200']['schema'];
export type AnderswassenChaosproxyConfigConfig = paths['/chaosproxy-configinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createAnderswassenChaosproxyConfigInstance(ctx: Context, body: AnderswassenChaosproxyConfigConfig): Promise<AnderswassenChaosproxyConfig>;
/**
 ...
 */
export declare function removeAnderswassenChaosproxyConfigInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {AnderswassenChaosproxyConfig} - Service instance
 */
export declare function getAnderswassenChaosproxyConfigInstance(ctx: Context, name: string): Promise<AnderswassenChaosproxyConfig>;
//# sourceMappingURL=anderswassen-chaosproxy-config.d.ts.map