...
export type ChambanaNetDockerPodcastgen = paths['/docker-podcastgeninstance/{id}']['get']['responses']['200']['schema'];
export type ChambanaNetDockerPodcastgenConfig = paths['/docker-podcastgeninstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createChambanaNetDockerPodcastgenInstance(ctx: Context, body: ChambanaNetDockerPodcastgenConfig): Promise<ChambanaNetDockerPodcastgen>;
/**
 ...
 */
export declare function removeChambanaNetDockerPodcastgenInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {ChambanaNetDockerPodcastgen} - Service instance
 */
export declare function getChambanaNetDockerPodcastgenInstance(ctx: Context, name: string): Promise<ChambanaNetDockerPodcastgen>;
//# sourceMappingURL=chambana-net-docker-podcastgen.d.ts.map