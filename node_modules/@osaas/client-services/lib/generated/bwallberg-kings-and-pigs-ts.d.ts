...
export type BwallbergKingsAndPigsTs = paths['/kings-and-pigs-tsinstance/{id}']['get']['responses']['200']['schema'];
export type BwallbergKingsAndPigsTsConfig = paths['/kings-and-pigs-tsinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createBwallbergKingsAndPigsTsInstance(ctx: Context, body: BwallbergKingsAndPigsTsConfig): Promise<BwallbergKingsAndPigsTs>;
/**
 ...
 */
export declare function removeBwallbergKingsAndPigsTsInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {BwallbergKingsAndPigsTs} - Service instance
 */
export declare function getBwallbergKingsAndPigsTsInstance(ctx: Context, name: string): Promise<BwallbergKingsAndPigsTs>;
//# sourceMappingURL=bwallberg-kings-and-pigs-ts.d.ts.map