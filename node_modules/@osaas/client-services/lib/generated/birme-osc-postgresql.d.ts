...
export type BirmeOscPostgresql = paths['/osc-postgresqlinstance/{id}']['get']['responses']['200']['schema'];
export type BirmeOscPostgresqlConfig = paths['/osc-postgresqlinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createBirmeOscPostgresqlInstance(ctx: Context, body: BirmeOscPostgresqlConfig): Promise<BirmeOscPostgresql>;
/**
 ...
 */
export declare function removeBirmeOscPostgresqlInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {BirmeOscPostgresql} - Service instance
 */
export declare function getBirmeOscPostgresqlInstance(ctx: Context, name: string): Promise<BirmeOscPostgresql>;
//# sourceMappingURL=birme-osc-postgresql.d.ts.map