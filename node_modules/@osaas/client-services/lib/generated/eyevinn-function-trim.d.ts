...
export type EyevinnFunctionTrim = paths['/function-triminstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnFunctionTrimConfig = paths['/function-triminstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnFunctionTrimInstance(ctx: Context, body: EyevinnFunctionTrimConfig): Promise<EyevinnFunctionTrim>;
/**
 ...
 */
export declare function removeEyevinnFunctionTrimInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnFunctionTrim} - Service instance
 */
export declare function getEyevinnFunctionTrimInstance(ctx: Context, name: string): Promise<EyevinnFunctionTrim>;
//# sourceMappingURL=eyevinn-function-trim.d.ts.map