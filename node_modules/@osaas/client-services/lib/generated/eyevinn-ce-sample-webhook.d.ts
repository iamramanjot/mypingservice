...
export type EyevinnCeSampleWebhook = paths['/ce-sample-webhookinstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnCeSampleWebhookConfig = paths['/ce-sample-webhookinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnCeSampleWebhookInstance(ctx: Context, body: EyevinnCeSampleWebhookConfig): Promise<EyevinnCeSampleWebhook>;
/**
 ...
 */
export declare function removeEyevinnCeSampleWebhookInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnCeSampleWebhook} - Service instance
 */
export declare function getEyevinnCeSampleWebhookInstance(ctx: Context, name: string): Promise<EyevinnCeSampleWebhook>;
//# sourceMappingURL=eyevinn-ce-sample-webhook.d.ts.map