...
export type EyevinnPdsAdmin = paths['/pds-admininstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnPdsAdminConfig = paths['/pds-admininstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnPdsAdminInstance(ctx: Context, body: EyevinnPdsAdminConfig): Promise<EyevinnPdsAdmin>;
/**
 ...
 */
export declare function removeEyevinnPdsAdminInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnPdsAdmin} - Service instance
 */
export declare function getEyevinnPdsAdminInstance(ctx: Context, name: string): Promise<EyevinnPdsAdmin>;
//# sourceMappingURL=eyevinn-pds-admin.d.ts.map