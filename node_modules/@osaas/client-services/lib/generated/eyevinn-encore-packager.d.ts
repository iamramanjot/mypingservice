...
export type EyevinnEncorePackager = paths['/encore-packagerinstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnEncorePackagerConfig = paths['/encore-packagerinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnEncorePackagerInstance(ctx: Context, body: EyevinnEncorePackagerConfig): Promise<EyevinnEncorePackager>;
/**
 ...
 */
export declare function removeEyevinnEncorePackagerInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnEncorePackager} - Service instance
 */
export declare function getEyevinnEncorePackagerInstance(ctx: Context, name: string): Promise<EyevinnEncorePackager>;
//# sourceMappingURL=eyevinn-encore-packager.d.ts.map