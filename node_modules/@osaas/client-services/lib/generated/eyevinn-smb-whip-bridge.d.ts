...
export type EyevinnSmbWhipBridge = paths['/smb-whip-bridgeinstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnSmbWhipBridgeConfig = paths['/smb-whip-bridgeinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnSmbWhipBridgeInstance(ctx: Context, body: EyevinnSmbWhipBridgeConfig): Promise<EyevinnSmbWhipBridge>;
/**
 ...
 */
export declare function removeEyevinnSmbWhipBridgeInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnSmbWhipBridge} - Service instance
 */
export declare function getEyevinnSmbWhipBridgeInstance(ctx: Context, name: string): Promise<EyevinnSmbWhipBridge>;
//# sourceMappingURL=eyevinn-smb-whip-bridge.d.ts.map