...
export type EyevinnLiveEncoding = paths['/live-encodinginstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnLiveEncodingConfig = paths['/live-encodinginstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnLiveEncodingInstance(ctx: Context, body: EyevinnLiveEncodingConfig): Promise<EyevinnLiveEncoding>;
/**
 ...
 */
export declare function removeEyevinnLiveEncodingInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnLiveEncoding} - Service instance
 */
export declare function getEyevinnLiveEncodingInstance(ctx: Context, name: string): Promise<EyevinnLiveEncoding>;
//# sourceMappingURL=eyevinn-live-encoding.d.ts.map