...
export type EyevinnSrtWhep = paths['/srt-whepinstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnSrtWhepConfig = paths['/srt-whepinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnSrtWhepInstance(ctx: Context, body: EyevinnSrtWhepConfig): Promise<EyevinnSrtWhep>;
/**
 ...
 */
export declare function removeEyevinnSrtWhepInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnSrtWhep} - Service instance
 */
export declare function getEyevinnSrtWhepInstance(ctx: Context, name: string): Promise<EyevinnSrtWhep>;
//# sourceMappingURL=eyevinn-srt-whep.d.ts.map