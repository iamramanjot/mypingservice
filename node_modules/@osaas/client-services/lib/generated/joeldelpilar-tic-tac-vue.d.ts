...
export type JoeldelpilarTicTacVue = paths['/tic-tac-vueinstance/{id}']['get']['responses']['200']['schema'];
export type JoeldelpilarTicTacVueConfig = paths['/tic-tac-vueinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createJoeldelpilarTicTacVueInstance(ctx: Context, body: JoeldelpilarTicTacVueConfig): Promise<JoeldelpilarTicTacVue>;
/**
 ...
 */
export declare function removeJoeldelpilarTicTacVueInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {JoeldelpilarTicTacVue} - Service instance
 */
export declare function getJoeldelpilarTicTacVueInstance(ctx: Context, name: string): Promise<JoeldelpilarTicTacVue>;
//# sourceMappingURL=joeldelpilar-tic-tac-vue.d.ts.map