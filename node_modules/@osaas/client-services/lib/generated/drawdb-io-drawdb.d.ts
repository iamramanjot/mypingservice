...
export type DrawdbIoDrawdb = paths['/drawdbinstance/{id}']['get']['responses']['200']['schema'];
export type DrawdbIoDrawdbConfig = paths['/drawdbinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createDrawdbIoDrawdbInstance(ctx: Context, body: DrawdbIoDrawdbConfig): Promise<DrawdbIoDrawdb>;
/**
 ...
 */
export declare function removeDrawdbIoDrawdbInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {DrawdbIoDrawdb} - Service instance
 */
export declare function getDrawdbIoDrawdbInstance(ctx: Context, name: string): Promise<DrawdbIoDrawdb>;
//# sourceMappingURL=drawdb-io-drawdb.d.ts.map