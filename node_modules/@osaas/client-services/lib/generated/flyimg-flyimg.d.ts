...
export type FlyimgFlyimg = paths['/flyimginstance/{id}']['get']['responses']['200']['schema'];
export type FlyimgFlyimgConfig = paths['/flyimginstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createFlyimgFlyimgInstance(ctx: Context, body: FlyimgFlyimgConfig): Promise<FlyimgFlyimg>;
/**
 ...
 */
export declare function removeFlyimgFlyimgInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {FlyimgFlyimg} - Service instance
 */
export declare function getFlyimgFlyimgInstance(ctx: Context, name: string): Promise<FlyimgFlyimg>;
//# sourceMappingURL=flyimg-flyimg.d.ts.map