...
export type Encore = paths['/encoreinstance/{id}']['get']['responses']['200']['schema'];
export type EncoreConfig = paths['/encoreinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEncoreInstance(ctx: Context, body: EncoreConfig): Promise<Encore>;
/**
 ...
 */
export declare function removeEncoreInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {Encore} - Service instance
 */
export declare function getEncoreInstance(ctx: Context, name: string): Promise<Encore>;
