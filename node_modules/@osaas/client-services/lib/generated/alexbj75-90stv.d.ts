...
export type Alexbj7590stv = paths['/90stvinstance/{id}']['get']['responses']['200']['schema'];
export type Alexbj7590stvConfig = paths['/90stvinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createAlexbj7590stvInstance(ctx: Context, body: Alexbj7590stvConfig): Promise<Alexbj7590stv>;
/**
 ...
 */
export declare function removeAlexbj7590stvInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {Alexbj7590stv} - Service instance
 */
export declare function getAlexbj7590stvInstance(ctx: Context, name: string): Promise<Alexbj7590stv>;
//# sourceMappingURL=alexbj75-90stv.d.ts.map