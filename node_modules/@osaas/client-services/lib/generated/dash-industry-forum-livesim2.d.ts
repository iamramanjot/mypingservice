...
export type DashIndustryForumLivesim2 = paths['/livesim2instance/{id}']['get']['responses']['200']['schema'];
export type DashIndustryForumLivesim2Config = paths['/livesim2instance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createDashIndustryForumLivesim2Instance(ctx: Context, body: DashIndustryForumLivesim2Config): Promise<DashIndustryForumLivesim2>;
/**
 ...
 */
export declare function removeDashIndustryForumLivesim2Instance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {DashIndustryForumLivesim2} - Service instance
 */
export declare function getDashIndustryForumLivesim2Instance(ctx: Context, name: string): Promise<DashIndustryForumLivesim2>;
//# sourceMappingURL=dash-industry-forum-livesim2.d.ts.map