...
export type BirmeCaptchaSvc = paths['/captcha-svcinstance/{id}']['get']['responses']['200']['schema'];
export type BirmeCaptchaSvcConfig = paths['/captcha-svcinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createBirmeCaptchaSvcInstance(ctx: Context, body: BirmeCaptchaSvcConfig): Promise<BirmeCaptchaSvc>;
/**
 ...
 */
export declare function removeBirmeCaptchaSvcInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {BirmeCaptchaSvc} - Service instance
 */
export declare function getBirmeCaptchaSvcInstance(ctx: Context, name: string): Promise<BirmeCaptchaSvc>;
//# sourceMappingURL=birme-captcha-svc.d.ts.map