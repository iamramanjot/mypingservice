...
export type WordpressWordpress = paths['/wordpressinstance/{id}']['get']['responses']['200']['schema'];
export type WordpressWordpressConfig = paths['/wordpressinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createWordpressWordpressInstance(ctx: Context, body: WordpressWordpressConfig): Promise<WordpressWordpress>;
/**
 ...
 */
export declare function removeWordpressWordpressInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {WordpressWordpress} - Service instance
 */
export declare function getWordpressWordpressInstance(ctx: Context, name: string): Promise<WordpressWordpress>;
//# sourceMappingURL=wordpress-wordpress.d.ts.map