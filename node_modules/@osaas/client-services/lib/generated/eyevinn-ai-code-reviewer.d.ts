...
export type EyevinnAiCodeReviewer = paths['/ai-code-reviewerinstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnAiCodeReviewerConfig = paths['/ai-code-reviewerinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnAiCodeReviewerInstance(ctx: Context, body: EyevinnAiCodeReviewerConfig): Promise<EyevinnAiCodeReviewer>;
/**
 ...
 */
export declare function removeEyevinnAiCodeReviewerInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnAiCodeReviewer} - Service instance
 */
export declare function getEyevinnAiCodeReviewerInstance(ctx: Context, name: string): Promise<EyevinnAiCodeReviewer>;
//# sourceMappingURL=eyevinn-ai-code-reviewer.d.ts.map