...
export type EyevinnSgaiAdProxy = paths['/sgai-ad-proxyinstance/{id}']['get']['responses']['200']['schema'];
export type EyevinnSgaiAdProxyConfig = paths['/sgai-ad-proxyinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createEyevinnSgaiAdProxyInstance(ctx: Context, body: EyevinnSgaiAdProxyConfig): Promise<EyevinnSgaiAdProxy>;
/**
 ...
 */
export declare function removeEyevinnSgaiAdProxyInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {EyevinnSgaiAdProxy} - Service instance
 */
export declare function getEyevinnSgaiAdProxyInstance(ctx: Context, name: string): Promise<EyevinnSgaiAdProxy>;
//# sourceMappingURL=eyevinn-sgai-ad-proxy.d.ts.map