...
export type OlawalejuwonmAnomalydetector = paths['/anomalydetectorinstance/{id}']['get']['responses']['200']['schema'];
export type OlawalejuwonmAnomalydetectorConfig = paths['/anomalydetectorinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createOlawalejuwonmAnomalydetectorInstance(ctx: Context, body: OlawalejuwonmAnomalydetectorConfig): Promise<OlawalejuwonmAnomalydetector>;
/**
 ...
 */
export declare function removeOlawalejuwonmAnomalydetectorInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {OlawalejuwonmAnomalydetector} - Service instance
 */
export declare function getOlawalejuwonmAnomalydetectorInstance(ctx: Context, name: string): Promise<OlawalejuwonmAnomalydetector>;
//# sourceMappingURL=olawalejuwonm-anomalydetector.d.ts.map