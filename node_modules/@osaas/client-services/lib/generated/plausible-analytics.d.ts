...
export type PlausibleAnalytics = paths['/analyticsinstance/{id}']['get']['responses']['200']['schema'];
export type PlausibleAnalyticsConfig = paths['/analyticsinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createPlausibleAnalyticsInstance(ctx: Context, body: PlausibleAnalyticsConfig): Promise<PlausibleAnalytics>;
/**
 ...
 */
export declare function removePlausibleAnalyticsInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {PlausibleAnalytics} - Service instance
 */
export declare function getPlausibleAnalyticsInstance(ctx: Context, name: string): Promise<PlausibleAnalytics>;
//# sourceMappingURL=plausible-analytics.d.ts.map