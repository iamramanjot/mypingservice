...
export type OwncastOwncast = paths['/owncastinstance/{id}']['get']['responses']['200']['schema'];
export type OwncastOwncastConfig = paths['/owncastinstance']['post']['parameters']['body']['body'];
 ...
 */
export declare function createOwncastOwncastInstance(ctx: Context, body: OwncastOwncastConfig): Promise<OwncastOwncast>;
/**
 ...
 */
export declare function removeOwncastOwncastInstance(ctx: Context, name: string): Promise<void>;
/**
 ...
 * @returns {OwncastOwncast} - Service instance
 */
export declare function getOwncastOwncastInstance(ctx: Context, name: string): Promise<OwncastOwncast>;
//# sourceMappingURL=owncast-owncast.d.ts.map